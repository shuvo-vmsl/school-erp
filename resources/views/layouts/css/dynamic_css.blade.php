...
.sidebar .sidebar-wrapper {
    background: {{ get_option('sidebar_color') != "" ? get_option('sidebar_color') : '#333333' }};
}

.sidebar .nav li:not(.active) > a, .sidebar[data-background-color="white"] .nav li:not(.active) > a{
	color: {{ get_option('sidebar_text_color') != "" ? get_option('sidebar_text_color') : '#fff' }};
}
...
.sidebar[data-active-color="danger"] .nav li.active > a{
	background: {{ $acb != "" ? $acb : '#666666' }};
}

.nav li.active > ul>li.active > a {
    color: {{ $acb != "" ? $acb : '#666666' }} !important;
}
